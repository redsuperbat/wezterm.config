...
keybind("h", "CTRL", act.ActivatePaneDirection("Left"))
keybind("j", "CTRL", act.ActivatePaneDirection("Down"))
keybind("k", "CTRL", act.ActivatePaneDirection("Up"))
keybind("l", "CTRL", act.ActivatePaneDirection("Right"))
